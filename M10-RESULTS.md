...
2. **It reaches deeper.** M7 finds the RV floor on the best imaged companion is ~0.4 M_Jup.
   Kral et al. 2026 claim GRAVITY feasibility "to detect moons with masses lower than
...
And it is no longer hypothetical. Kral et al. 2026
...
Kral et al. §6 cut their sample on K < 20 mag and host–companion contrast < 10⁵, leaving
...
**The candidate is reproducible.** HD 206893 B — where Kral et al. report their residuals —
...
- one of Kral et al.'s **two best short-term astrometric targets**;
...
- **It is a reanalysis of someone else's survey**, exactly as M5 concluded for the RV
  analogue search. Kral et al. are actively working these targets.
...
- Kral et al. list a sixth target, HD 60584 b, omitted here: it is an unconfirmed candidate
