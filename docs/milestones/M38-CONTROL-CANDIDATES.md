...
| V340 Ara | preliminary archive screening notes suggest public H1567 conventional-slit observations, but the exact query/export is not retained in this repository | possible supplemental high-amplitude research lead; independent optical Cepheid studies establish substantial variability | the optical-to-H-band centroid transfer is not rigid, the archive facts must be re-established from a frozen query, and the apparent slit/spectral type differ; exact products and calibrations have not been frozen | **screened conditional research lead; not sufficient, selected, or frozen** |
...
[Hocde et al. 2024](https://doi.org/10.1051/0004-6361/202347798). Those sources support only
the qualitative screening premise that V340 Ara is an RV-variable Cepheid. The exact archive
roster, slit, dates, optical phase calculation, and projected inter-night change are not bound
by a query export or calculation artifact in this repository and therefore are not evidence
for selection. Published optical/infrared Cepheid
...
material concerns that require a frozen archive record. If M38
