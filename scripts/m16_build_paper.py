...
CAPTIONS = {
    ...
    "FIG3": ("fig3_landscapes.svg",
             ("<b>Figure 3.</b> Target-aware period search (ΔBIC of a circular Keplerian "
             "vs a constant; internally screened series). Left: CD-35 2722 B — the published "
             ...
             "Dotted vertical line: 171.45 d in both panels; dashed: ΔBIC = 10. This "
             "screen-conditioned landscape is not the all-epoch M37 global calibration.")),
    ...
    "FIG5": ("fig5_periodograms.svg",
             ...
             "two circular signals at the published periods. Dashed rules are Astropy's "
             "analytic maximum-peak false-alarm approximations for the plotted grid at "
             "10%, 1% and 0.1% (bottom to top), not M37's residual-permutation p-values; "
             "the dotted vertical is "
    ...
    "FIG9": ("fig9_windowmodels.svg",
             ...
             "Fig. 6. Our re-fit of their table recovers their argument against the 14 d "
             "solution: it "
             ...
             "agrees, while the case for adding any of them does not.")),
    "FIG10": ("fig10_viper_gls.svg",
              ...
              "over orders from the audited tables under "
              "<code>data/repro/viper/results/</code>.")),
...
PAIRS = {
    "FIG5": ("H26 Fig. 1", "Figure 4", "screened-series agreement", "part"),
    "FIG6": ("H26 Fig. 2", "Figure 5", "screened-series comparison", "part"),
    ...
    "FIG10": ("H26 Fig. 7", "Figure 9", "conditional agreement · BERV added", "part"),
    "FIG11": ("H26 Fig. 8", "Figure 10", "published-table re-fit agrees", "part"),
    "FIG12": ("H26 Fig. 9", "Figure 11", "published-table amplitude differs", "no"),
}
